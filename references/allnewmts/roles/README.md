...
| Role | Paperclip enum | ID | reportsTo | Task 생성 경로 | Agent 생성 | Skill 생성 |
|---|---|---|---|---:|---:|---:|
| Product Steward | `ceo` | `6b6296b0-c22d-4a63-a578-ef1041ec7541` | Board | Operation Control Root | 가능 | 가능 |
| Prototyper | `researcher` | `e154b480-a914-4b1f-b40b-209ee332760d` | Product Steward | 자기 Node 아래 plugin child만 | 불가 | 불가 |
| Builder | `engineer` | `0c82b32e-682c-4e8e-a53e-5790eaeadcbf` | Product Steward | 자기 Node 아래 plugin child만 | 불가 | 불가 |
| Sweeper | `qa` | `f1cf482a-27cf-44de-a5e0-1d9274485453` | Product Steward | 자기 Node 아래 plugin child만 | 불가 | 불가 |
| Grower | `pm` | `d96accca-eb75-4b55-8a69-9608fe1a93a2` | Product Steward | 자기 Node 아래 plugin child만 | 불가 | 불가 |
| Maintainer | `devops` | `56cd8c39-6c19-4bf0-a6bb-8390e7b1bcd1` | Product Steward | normal에서 자기 Node 아래 plugin child만 | 불가 | 불가 |
...
| Role | 수행 | 수행하지 않음 |
|---|---|---|
| Product Steward | Goal 정렬, controlled Root 배정, Backlog 승격, keep/kill, review 전환 | 제품 코드·스펙·Fixture 작성, 자기 결과 승인 |
